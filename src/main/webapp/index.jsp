...
<body>
<h2>Jcble Paas
    <small class="badge" title="Version">0.1-beta</small>
</h2>

<p>
    <a href="${contextPath}/user/tologin">Sign in</a>
    &nbsp;|&nbsp;
    <%-- <a href="${contextPath}/logout">Logout</a> --%>
    <a href="${contextPath}/user/join">Sign up</a> 
</p>
...
<div>
    ...
    <ol>
        ...
        <li>
            <p>
            菜单Mobile 需要OAuth 验证后才能访问(即受保护的resource),Mobile 需要 [ROLE_MOBILE] 权限(resourceId:<mark>mobile-resource</mark>).
            </p>
        </li>
        <%-- <li>
            <p>
...
<ul>
    <li>
        <p>
            <a href="resources/api/Jcble_Paas_API.html" target="_blank">API</a> 
            <span class="text-muted">- 查看提供的API文档</span>
        </p>
    </li>
    <li>
        <p>
...
<div class="well well-sm">
    <p>
        <strong>说明</strong>: Mobile菜单需要先获取到<code>access_token</code>后才能正常访问; 可以尝试在URL后面任意添加access_token参数值试试效果,
        <br/>
