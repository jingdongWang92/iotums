...
<div>
    ...
    <p class="help-block">
        每一个item对应<code>oauth_client_details</code>表中的一条数据; 共<strong>${fun:length(clientDetailsList)}</strong>条数据.
        <br/>
        对spring-oauth-server数据库表的详细说明请访问
        <a href="http://localhost:8082/iotums/resources/db_table_description.html" target="_blank">http://localhost:8082/iotums/resources/db_table_description.html</a>
